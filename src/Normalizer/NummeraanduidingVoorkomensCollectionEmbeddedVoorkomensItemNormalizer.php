...
/**
 * Class NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItemNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItem';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItem;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItem|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItem();
        ...
        if (property_exists($data, '_links')) {
            $object->setLinks($this->denormalizer->denormalize($data->{'_links'}, 'BureauVierkant\\Basisregistratie\\Model\\NummeraanduidingVoorkomensCollectionEmbeddedVoorkomensItemLinks', 'json', $context));
        }
        return $object;
    }
