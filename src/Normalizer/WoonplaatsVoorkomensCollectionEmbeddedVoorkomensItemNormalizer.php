...
/**
 * Class WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItemNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItem';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItem;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItem|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItem();
        ...
        if (property_exists($data, '_links')) {
            $object->setLinks($this->denormalizer->denormalize($data->{'_links'}, 'BureauVierkant\\Basisregistratie\\Model\\WoonplaatsVoorkomensCollectionEmbeddedVoorkomensItemLinks', 'json', $context));
        }
        return $object;
    }
