...
/**
 * Class VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItemNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItem';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItem;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItem|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItem();
        ...
        if (property_exists($data, '_links')) {
            $object->setLinks($this->denormalizer->denormalize($data->{'_links'}, 'BureauVierkant\\Basisregistratie\\Model\\VerblijfsobjectVoorkomensCollectionEmbeddedVoorkomensItemLinks', 'json', $context));
        }
        return $object;
    }
