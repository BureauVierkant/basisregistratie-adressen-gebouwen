...
/**
 * Class StandplaatsVoorkomensCollectionEmbeddedVoorkomensItemNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class StandplaatsVoorkomensCollectionEmbeddedVoorkomensItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\StandplaatsVoorkomensCollectionEmbeddedVoorkomensItem';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\StandplaatsVoorkomensCollectionEmbeddedVoorkomensItem;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\StandplaatsVoorkomensCollectionEmbeddedVoorkomensItem|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\StandplaatsVoorkomensCollectionEmbeddedVoorkomensItem();
        ...
        if (property_exists($data, '_links')) {
            $object->setLinks($this->denormalizer->denormalize($data->{'_links'}, 'BureauVierkant\\Basisregistratie\\Model\\StandplaatsVoorkomensCollectionEmbeddedVoorkomensItemLinks', 'json', $context));
        }
        return $object;
    }
