...
/**
 * Class WoonplaatsEmbeddedNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class WoonplaatsEmbeddedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\WoonplaatsEmbedded';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\WoonplaatsEmbedded;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\WoonplaatsEmbedded|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\WoonplaatsEmbedded();
