...
/**
 * Class PandVoorkomensCollectionEmbeddedVoorkomensItemNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class PandVoorkomensCollectionEmbeddedVoorkomensItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\PandVoorkomensCollectionEmbeddedVoorkomensItem';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\PandVoorkomensCollectionEmbeddedVoorkomensItem;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\PandVoorkomensCollectionEmbeddedVoorkomensItem|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\PandVoorkomensCollectionEmbeddedVoorkomensItem();
        ...
        if (property_exists($data, '_links')) {
            $object->setLinks($this->denormalizer->denormalize($data->{'_links'}, 'BureauVierkant\\Basisregistratie\\Model\\PandVoorkomensCollectionEmbeddedVoorkomensItemLinks', 'json', $context));
        }
        return $object;
    }
