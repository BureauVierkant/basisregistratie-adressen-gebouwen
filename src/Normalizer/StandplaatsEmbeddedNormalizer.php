...
/**
 * Class StandplaatsEmbeddedNormalizer
 *
 * @package BureauVierkant\Basisregistratie\Normalizer
 */
class StandplaatsEmbeddedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\StandplaatsEmbedded';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\StandplaatsEmbedded;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\StandplaatsEmbedded|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\StandplaatsEmbedded();
