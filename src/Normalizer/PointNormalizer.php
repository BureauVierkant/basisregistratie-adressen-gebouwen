...
class PointNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'BureauVierkant\\Basisregistratie\\Model\\Point';
    }
    ...
    {
        return $data instanceof \BureauVierkant\Basisregistratie\Model\Point;
    }
     ...
     * @param array $context
     *
     * @return \BureauVierkant\Basisregistratie\Model\Point|object
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \BureauVierkant\Basisregistratie\Model\Point();
