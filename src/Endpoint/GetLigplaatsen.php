...
/**
 * Class GetLigplaatsen
 *
 * @package BureauVierkant\Basisregistratie\Endpoint
 */
class GetLigplaatsen extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        ...
        if (403 === $status) {
            throw new \BureauVierkant\Basisregistratie\Exception\GetLigplaatsenForbiddenException();
        }
    }
}